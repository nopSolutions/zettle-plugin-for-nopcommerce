    ...
    public class ZettlePlugin : BasePlugin, IMiscPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugins.Misc.Zettle.Credentials.AccessRevoked"] = "Access to Zettle organization has been revoked. You need to reconfigure the plugin.",
                ...
                ["Plugins.Misc.Zettle.Configuration.Fields.DisconnectOnUninstall.Hint"] = "Determine whether to disconnect an app (Revoke Access) from an associated Zettle organisation when the plugin is uninstalled. In this case you will need to go through the signing-up process again. If disabled, you can use the same credentials after reinstalling the plugin.",
                ...
                ["Plugins.Misc.Zettle.Configuration.Fields.DeleteBeforeImport.Hint"] = "Determine whether to delete existing library items before importing products to Zettle. It may be required on the first synchronization if you want to keep only products from nopCommerce catalog. After that, it's recommended to disable this setting.",
                ...
                ["Plugins.Misc.Zettle.Configuration.Fields.PriceSyncEnabled.Hint"] = "Determine whether to synchronize prices of the selected products by default. If disabled, prices will have to be set manually in Zettle.",
                ["Plugins.Misc.Zettle.Configuration.Fields.ImageSyncEnabled"] = "Image sync enabled",
                ["Plugins.Misc.Zettle.Configuration.Fields.ImageSyncEnabled.Hint"] = "Determine whether to synchronize images of the selected products by default. A product in Zettle library can have a single image assigned.",
                ...
                ["Plugins.Misc.Zettle.Configuration.Fields.DefaultTaxEnabled.Hint"] = "Determine whether to use the country's default VAT rate or default sales tax rate for new products. If disabled, taxes will have to be set manually in Zettle.",
                ["Plugins.Misc.Zettle.Configuration.Fields.DiscountSyncEnabled"] = "Add discounts",
                ["Plugins.Misc.Zettle.Configuration.Fields.DiscountSyncEnabled.Hint"] = "Determine whether to import discounts from nopCommerce catalog (assigned to order subtotal only) to Zettle.",
                ["Plugins.Misc.Zettle.Configuration.Webhook.Warning"] = "Webhook was not created (see details in the <a href=\"{0}\" target=\"_blank\">log</a>), so some functions may not work correctly. Please ensure that your store is under SSL, Zettle doesn't send requests to unsecured sites.",
                ...
                ["Plugins.Misc.Zettle.Account.Fields.Currency.Warning"] = "The <a href=\"{2}\" target=\"_blank\">primary store currency</a> ({0}) doesn't match the currency of the merchant's Zettle account ({1}). In this case, prices will not be synchronized and will have to be set manually",
                ...
                ["Plugins.Misc.Zettle.Account.Fields.TaxationType.Vat.Warning"] = "The VAT settings don't match the settings of the merchant's Zettle account. See <a href=\"{0}\" target=\"_blank\">Tax settings</a>",
                ["Plugins.Misc.Zettle.Account.Fields.TaxationType.SalesTax.Warning"] = "Default sales tax rate not set. Please complete your Zettle account setup before continuing, otherwise, no sales tax information will be applied to the imported products.",
                ...
                ["Plugins.Misc.Zettle.Account.Fields.TaxationMode.Warning"] = "The store price type doesn't match the price type of the merchant's Zettle account. See 'Prices include tax' in <a href=\"{0}\" target=\"_blank\">Tax settings</a>",
